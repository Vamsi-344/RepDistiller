...
def parse_option():
    ...
    if hostname.startswith('visiongpu'):
        ...
        opt.model_path = './save_savg_true/student_model'
        opt.tb_path = './save_savg_true/student_tensorboards'
...
def main():
    ...
    if opt.dataset == 'cifar100':
        if opt.distill in ['crd', 'mcrd', 'cmcrd']:
    ...
    elif opt.distill == 'crd' or opt.distill == 'mcrd' or opt.distill == 'cmcrd':
    ...
    elif opt.distill == 'rkd' or opt.distill == 'mrkd' or opt.distill == 'cmrkd':
    ...
    teacher_acc, _, _, ece, oe = validate(val_loader, model_t, criterion_cls, opt)
